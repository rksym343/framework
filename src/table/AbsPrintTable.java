...
import coffee.dao.DataDao;
import coffee.dao.SalesDao;
import coffee.dto.CoffeeCode;
import coffee.dto.Sale;

public abstract class AbsPrintTable extends AbsTable<Sale> {
	...
	public Sale getSelectedObject() {
		...
		Sale sale = SalesDao.getInstance().seleteItemByNo(new Sale(new CoffeeCode(code)));
		return sale;
	}
